...
### 2.2 项目结构
```
github.com/codex-switch/codex-switch/
├── cmd/
│   ├── root.go          # 根命令
│   ├── add.go           # 添加 Key
│   ├── list.go          # 列出所有 Key
...
### 3.1 配置文件结构
**存储位置**: `~/.github.com/codex-switch/codex-switch/config.json`
...
### 7.1 配置文件位置
- **Linux**: `~/.github.com/codex-switch/codex-switch/config.json`
- **配置目录权限**: `0700`
...
### 8.3 日志文件
- **位置**: `~/.github.com/codex-switch/codex-switch/logs/ckm.log`
- **滚动**: 按天滚动,保留 7 天
...
- 本地快照存放于 `~/.github.com/codex-switch/codex-switch/snapshots/<profile>.json`，文件权限默认为 `0600`。
...
# 或下载预编译二进制
wget https://github.com/yourusername/github.com/codex-switch/codex-switch/releases/latest/download/ckm-linux-amd64
